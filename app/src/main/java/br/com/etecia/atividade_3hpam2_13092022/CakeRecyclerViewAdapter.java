...
public class CakeRecyclerViewAdapter extends RecyclerView.Adapter<CakeRecyclerViewAdapter.MyViewHolder> {

    private Context mContext;
    private List<Cake> mData;

    public CakeRecyclerViewAdapter(Context mContext, List<Cake> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.cake_cardview, parent, false);
