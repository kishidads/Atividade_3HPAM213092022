...
public class JuiceRecyclerViewAdapter extends RecyclerView.Adapter<JuiceRecyclerViewAdapter.MyViewHolder> {

    private Context mContext;
    private List<Juice> mData;

    public JuiceRecyclerViewAdapter(Context mContext, List<Juice> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.juice_cardview, parent, false);
