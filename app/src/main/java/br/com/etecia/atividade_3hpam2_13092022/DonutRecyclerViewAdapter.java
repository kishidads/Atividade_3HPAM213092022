...
public class DonutRecyclerViewAdapter extends RecyclerView.Adapter<DonutRecyclerViewAdapter.MyViewHolder> {

    private Context mContext;
    private List<Donut> mData;

    public DonutRecyclerViewAdapter(Context mContext, List<Donut> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.donut_cardview, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, Juice_Activity.class);
