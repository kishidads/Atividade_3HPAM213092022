...
public class Juice_Activity extends AppCompatActivity {

    private TextView txtTitulo, txtDescricao, txtCategoria;
    private ImageView imgJuice;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.juice_card);
        ...
        imgJuice = findViewById(R.id.idImg);
        ...
        imgJuice.setImageResource(miniatura);
